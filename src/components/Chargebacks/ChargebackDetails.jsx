...
import CommentSection from './ChargebackFilesComments'; // Assurez-vous que le chemin du fichier est correct
import './ChargebackDetails .css'; // Assurez-vous que le chemin du fichier CSS est correct
    ...
    <div className="chargeback-details-container">
      ...
      <div className="right-section">
        ...
        <div className="buttons">
          ...
          <button className="button files-comments-button" onClick={handleOpenComments}>
            Go to Comments
          </button>
        </div>
